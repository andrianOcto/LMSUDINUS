      ...
      <div class="portlet box blue">
          <div class="portlet-title">
              ...
              <ul class="nav nav-tabs">
                  <li class="active">
                      <a aria-expanded="true" href="#portlet_tab3" data-toggle="tab"> Tab 3 </a>
                  </li>
                  <li class="">
                      <a aria-expanded="false" href="#portlet_tab2" data-toggle="tab"> Tab 2 </a>
                  </li>
                  <li class="">
                      <a aria-expanded="false" href="#portlet_tab1" data-toggle="tab"> Tab 1 </a>
                  </li>
              </ul>
          </div>
