        ...
        <div class="page-content">
            ...
            <div class="portlet light box green">
                ...
                <div class="portlet-body">
                  <form ng-submit="updateTable()" class="form-horizontal">
                      <div class="form-body">
                          <div class="form-group">
                              ...
                              <div class="col-md-4">
                                ...
                                @if ($i == 0)
                                <select ng-model="courseSelect" ng-init="courseSelect = '{{$course->id}}'" class="form-control">
                                @endif
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-4">
                                  <select id="roleTable" ng-model ="roleTable" ng-init="roleTable = '0'" class="form-control select2">
                          ...
                          <div class="form-actions">
                              <div class="row">
                                  <div class="col-md-offset-3 col-md-9">
                                      ...
                                      <button type="button" class="btn btn grey-salsa btn-outline">Reset</button>
                                  </div>
                              </div>
                          </div>
            ...
            <div class="portlet light bordered" ng-show="showTable">
                <div class="portlet-title">
                    <div class="caption">
                ...
                <div class="portlet-body">
                  <div class="table-scrollable">
                      <table class="table table-striped table-bordered table-hover" my-table="option" action-def="action" aa-data="data" aa-refresh="refresh">
                          <thead>
                              <tr>
                                  <th scope="col"> # </th>
